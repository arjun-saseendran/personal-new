...
export const Content = () => {
  return (
    <div className='flex items-center justify-around mt-20 h-[600px]'>
<div>
<img className='w-52 h-52 rounded-full' src="../../../public/dp.jpeg" alt="" />
</div>
<div>

<h1 className='text-3xl mb-5'>Angel Maria</h1>
